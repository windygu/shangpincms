...
{
    public class ProductInfoShoes : PagingEntityBase
    {
        ...
        public int NewArrivalProductListId { get; set; }

        public string NewArrivalTitle { get; set; }//上新标题
        public DateTime StartDate { get; set; }//开始上新时间

        public int SortValue { get; set; }//排序

        public string WebSiteNo { get; set; }//网站编号：shangpin.com

        public string PagePositionNo { get; set; }//楼层编号

        public string PagePositionName { get; set; }//对应楼层编号名称
        public string PageNo { get; set; }//频道页编号（首页:index，女鞋:womenshoes）
