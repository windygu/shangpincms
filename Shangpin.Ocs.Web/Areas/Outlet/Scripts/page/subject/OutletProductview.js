...
function btnSubmit() {
    ...
    if (showType == "0")
        window.location.href = "/Outlet/Subject/OutletProductView?subjectNo=" + _subjectNo + "&SortType=" + tempSortType + "&SCategoryNo=" + subjectNo + "&IsAutoBottom=" + isAutoBottom + "&isOne=1&t=" + new Date().getTime()
    else
        window.location.href = "/Outlet/Subject/OutletProductMobileView?subjectNo=" + _subjectNo + "&SortType=" + tempSortType + "&SCategoryNo=" + subjectNo + "&IsAutoBottom=" + isAutoBottom + "&isOne=1&t=" + new Date().getTime()
