...
;(function(window, $, SPModeWindowCollection){
    var brfsWindow = function(setting){
        ...
        return SPModeWindowCollection.add("sp_modewindow_brfs", {
            ...
            html: {
                title : "区域编辑",
                content : "<p>上传图片：<img src='/images/e.gif' width='48' height='48' style='vertical-align: bottom;' /><input type='file' id='sp_brfs_edit_imgfile' name='sp_brfs_edit_imgfile' mutiple='true' /></p><p>图片链接：<input type='text' id='sp_brfs_edit_imgurl' name='sp_brfs_edit_imgurl' /></p><div class='sp_brfs_edit_wrapper'><a href='#' id='sp_brfs_edit_submit'>确定</a>&nbsp;&nbsp;<a href='#' id='sp_brfs_edit_cancel'>取消</a></div>"
            },
            binder:function(){
                var _this = this;
