...
jQuery.fn.selectBrand = function(objID,objName,IsLoad,SubformID,functionName) {    
		var _seft = this;
		var url = "/outlet/subject/AjaxBrand?IDControl=" + objID + "&nameControl=" + objName + "&SubformID=" + SubformID + "&functionName=" + functionName+"&selectType=1";	
		var targetWidth=320;  //宽度
		var targetHeight=250;  //高度
		var targetId =$("<iframe id='BrandIframe'  marginheight='0' marginwidth='0' scrolling='auto' frameborder='0'  style='border:3px solid #8492A9;display:none;width:"+targetWidth+"px; height :"+targetHeight+"px;background-color:#EDEDED;z-index:999'></iframe>"); 	
	    if(IsLoad){
	...
	function changeBrandListItemsStatus(inputTxt)
	{
	        ...
	        //包含品牌的div
	        var divBrandList=document.getElementById("BrandIframe").contentWindow.document.getElementById("brand"+firstLetter); 
	        //所有的div
	        var divs=document.getElementById("BrandIframe").contentWindow.document.getElementsByTagName("div");
	        //所有的span
	        var brandEnNameSpans=document.getElementById("BrandIframe").contentWindow.document.getElementsByTagName("span");
...
//        
//            var oEventIE = window.event;
//            //alert(oEventIE.keyCode);
//            if(document.getElementById("BrandIframe").style.display!="none")
//            {
//                //alert("显示");
//                changeSelect(oEventIE.keyCode);
//            }
//         
//    };
//} 
