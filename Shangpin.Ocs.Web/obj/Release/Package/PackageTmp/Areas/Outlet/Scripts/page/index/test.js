...
function lz_main() {
    var unit_id = "2920265";
    var client_ip = "119.188.50.1";
    var server_time = "1371525137";
    var verify_code = "8a32b245";
    var type = "0";
    ...
    if (url_id > 0)
        document.write('<scr' + 'ipt src=\'http://js.tongji.linezing.com/2920265/' + url_id + '/clickcollect.js\'></scr' + 'ipt>');
}
